...
public class TwoDimArrayPractice extends JFrame
{
    ...
    // Write your code here:
       for (int row = 0; row < intArray.length; row++) {
           for (int column = 0; column < intArray[row].length; column++) {
               ...
               animate(row, column); // Animate each element
           }
   ...
   public void setValues( int value, int row )
   {
    ...
    // Write your code here:
       for (int column = 0; column < intArray[row].length; column++) {
           ...
           animate(row, column); // triggers the visual update
       }
   ...
   */
   public int findMinimum( int column )
   {
    ...
    // Write your code here:
       int minimum = intArray[0][column]; // Start with the first value in the column

       for (int row = 0; row < intArray.length; row++) {
           if (intArray[row][column] < minimum) {
               minimum = intArray[row][column]; // Update if a smaller value is found
           }
           animate(row, column, minimum); // Animate each comparison
       }
    ...
    // Write your code here:
       ...
       for (int row = 0; row < intArray.length; row++) {
           for (int column = 0; column < intArray[row].length; column++) {
               ...
               animate(row, column, count); // Animate each comparison
           }
       }
